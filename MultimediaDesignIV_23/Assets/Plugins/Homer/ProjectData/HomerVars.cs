...
public static class HomerActors {
    public enum Actors {UN_NOME, THE_MISCHIEF_MAKER, GRUNTER_THE_GUARD, MYSTICO_MCFLOP, NARRATOR, GRAZIANO_RUGON, ALVERON, ACHILLES, TRIOPAS, AGAMENNON, PLAYER, PARIS, TROJANS, GREEKS, HOMER, ZEUS}
